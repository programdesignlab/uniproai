...
export function regimeAllocation(regime: string): AllocationConfig {
  switch (regime) {
    case "Strong Bull":
      return { max_equity_pct: 100, max_positions: 20, risk_per_trade_pct: 1.5 }
    case "Bull":
      return { max_equity_pct: 80, max_positions: 15, risk_per_trade_pct: 1.25 }
    case "Weak":
      return { max_equity_pct: 50, max_positions: 10, risk_per_trade_pct: 1.0 }
    case "Bear":
      return { max_equity_pct: 25, max_positions: 5, risk_per_trade_pct: 0.75 }
    case "Full Bear":
